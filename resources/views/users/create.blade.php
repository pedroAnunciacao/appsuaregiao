        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Cadastrar Usuário</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('users.store') }}" method="POST" data-parsley-validate>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control telefone" id="phone" name="phone" value="{{ old('phone') }}">
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-save me-1"></i> Cadastrar Usuário
                                </button>
                            </div>
                        </form>
                    </div>
