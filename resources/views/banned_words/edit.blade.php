...
<div class="row">
    <div class="col-lg-6 offset-lg-3">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Editar Palavra Banida</h4>

                {{-- Changed route() to hardcoded URL --}}
                <form action="/banned-words/update/{{ $bannedWord->id }}" method="PUT">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label for="word" class="form-label">Palavra <span style="color: var(--color-danger);">*</span></label>
                        <input type="text" class="form-control" id="word" name="word" value="{{ old('word', $bannedWord->word) }}" required>
                    ...
                    <div class="d-flex justify-content-between" style="margin-top: 2rem;">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save"></i> Atualizar Palavra
                        </button>
                    </div>
                </form>
            </div>
